Load "Some_more_tools.v".
 ...
 Record StakeholderBaseP { HM I64 B I32 A }  := StakeholderBaseC  { 
 ...
 Record RoundsBaseP { I8 HM I64 I32 A }  := RoundsBaseC  { 
 ...
 Arguments RoundsBaseC  [ I8 HM I64 I32 A ] 
   . 
 Record StakingContractP { I I64 I8 B HM I256 I32 }  := StakingContractC  { 
 ...
 Arguments StakingContractC  [ I I64 I8 B HM I256 I32 ] 
   . 
 ...
 Record TestElectorP { HM I32 I64 I256 I8 }  := TestElectorC  { 
 ...
 Arguments TestElectorC  [ HM I32 I64 I256 I8 ] 
   . 
 Record LedgerP { A I64 I256 I32 I8 B }  := LedgerC  { 
 	Ledger_ι_OwnerBase_ι_Owner : (@ OwnerBase_ι_OwnerP A I64 ) ; 
 	Ledger_ι_ElectorBase_ι_Request : (@ ElectorBase_ι_RequestP I64 I256 I32 I8 ) ; 
 	Ledger_ι_ElectionParams_ι_ValidatorDescr73 : (@ ElectionParams_ι_ValidatorDescr73P I8 I32 I256 I64 ) ; 
 	Ledger_ι_StakeholderBase_ι_Stakeholder : (@ StakeholderBase_ι_StakeholderP I64 B I32 A )  
 	(* Ledger_ι_StakingOwner_ι_Address : (@ StakingOwner_ι_AddressP A ) ; 
 	Ledger_ι_RoundsBase_ι_StakeValue : (@ RoundsBase_ι_StakeValueP I64 ) ; 
 	Ledger_ι_RoundsBase_ι_Round : (@ RoundsBase_ι_RoundP HM I32 I8 I64 A ) ; 
 	Ledger_ι_RoundsBase_ι_RoundInfo : (@ RoundsBase_ι_RoundInfoP I32 I8 I64 ) ; 
 	Ledger_ι_DePool_ι_StakeInfo : (@ DePool_ι_StakeInfoP I32 I64 ) ; 
 	Ledger_ι_TestElector_ι_Validator : (@ TestElector_ι_ValidatorP I64 I256 I32 I8 ) ;
  Ledger_ι_StakingProxyContract : (@ StakingProxyContractP I64 A ) *)
 } . 
 Arguments LedgerC  [ A I64 I256 I32 I8 B ]  . 
...
Global Instance Acc_StakingProxyContract_ι_m_elector : Accessor StakingProxyContract_ι_m_elector :=  {  acc := ·1  }   . 
Global Instance Acc_StakingProxyContract_ι_m_staking : Accessor StakingProxyContract_ι_m_staking :=  {  acc := ·2  }   . 
...
Definition  RoundsBase  := @RoundsBaseP  XInteger8 XHMap XInteger64 XInteger32 XAddress . 
...
Global Instance Struct_RoundsBase : Struct RoundsBase :=  { 
 	...
 	ctor := @RoundsBaseC XInteger8 XHMap XInteger64 XInteger32 XAddress  
 }   . 
...
Definition  StakingContract  := @StakingContractP  XInteger XInteger64 XInteger8 XBool XHMap XInteger256 XInteger32 . 
Global Instance Struct_StakingContract : Struct StakingContract :=  { 
 	...
 	ctor := @StakingContractC XInteger XInteger64 XInteger8 XBool XHMap XInteger256 XInteger32
 }   . 
...
Global Instance Acc_StakingContract_ι_m_minStake : Accessor StakingContract_ι_m_minStake :=  {  acc := ·31  }   . 
Global Instance Acc_StakingContract_ι_m_minRoundStake : Accessor StakingContract_ι_m_minRoundStake :=  {  acc := ·32  }   . 
Global Instance Acc_StakingContract_ι_m_maxRoundStake : Accessor StakingContract_ι_m_maxRoundStake :=  {  acc := ·33  }   . 
Global Instance Acc_StakingContract_ι_m_lastRoundInterest : Accessor StakingContract_ι_m_lastRoundInterest :=  {  acc := ·34  }   . 
Instance StakingContract_default : XDefault StakingContract :=  {  
 	 default := StakingContractC default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default  
  }   . 
...
Definition  Ledger  := @LedgerP XAddress XInteger64 XInteger256 XInteger32 XInteger8 XBool (* XHMap *)  . 
Global Instance Struct_Ledger : Struct Ledger :=  { 
 	fields :=  [ 
 		@existT _ _ _ Ledger_ι_OwnerBase_ι_Owner , 
 		@existT _ _ _ Ledger_ι_ElectorBase_ι_Request , 
 		@existT _ _ _ Ledger_ι_ElectionParams_ι_ValidatorDescr73 , 
 		@existT _ _ _ Ledger_ι_StakeholderBase_ι_Stakeholder  
 		(* @existT _ _ _ Ledger_ι_StakingOwner_ι_Address , 
 		@existT _ _ _ Ledger_ι_RoundsBase_ι_StakeValue , 
 		@existT _ _ _ Ledger_ι_RoundsBase_ι_Round , 
 		@existT _ _ _ Ledger_ι_RoundsBase_ι_RoundInfo , 
 		@existT _ _ _ Ledger_ι_DePool_ι_StakeInfo , 
 		@existT _ _ _ Ledger_ι_TestElector_ι_Validator ,
 		@existT _ _ _ Ledger_ι_StakingProxyContract *)
 	 ]   ;  
 	ctor := @LedgerC  XAddress XInteger64 XInteger256 XInteger32 XInteger8 XBool (* XHMap *)         
 }   . 
Global Instance Acc_Ledger_ι_OwnerBase_ι_Owner : Accessor Ledger_ι_OwnerBase_ι_Owner :=  {  acc := ·0  }   . 
Global Instance Acc_Ledger_ι_ElectorBase_ι_Request : Accessor Ledger_ι_ElectorBase_ι_Request :=  {  acc := ·1  }   . 
Global Instance Acc_Ledger_ι_ElectionParams_ι_ValidatorDescr73 : Accessor Ledger_ι_ElectionParams_ι_ValidatorDescr73 :=  {  acc := ·2  }   . 
Global Instance Acc_Ledger_ι_StakeholderBase_ι_Stakeholder : Accessor Ledger_ι_StakeholderBase_ι_Stakeholder :=  {  acc := ·3  }   . 
(* Global Instance Acc_Ledger_ι_StakingOwner_ι_Address : Accessor Ledger_ι_StakingOwner_ι_Address :=  {  acc := ·4  }   . 
Global Instance Acc_Ledger_ι_RoundsBase_ι_StakeValue : Accessor Ledger_ι_RoundsBase_ι_StakeValue :=  {  acc := ·5  }   . 
Global Instance Acc_Ledger_ι_RoundsBase_ι_Round : Accessor Ledger_ι_RoundsBase_ι_Round :=  {  acc := ·6  }   . 
Global Instance Acc_Ledger_ι_RoundsBase_ι_RoundInfo : Accessor Ledger_ι_RoundsBase_ι_RoundInfo :=  {  acc := ·7  }   . 
Global Instance Acc_Ledger_ι_DePool_ι_StakeInfo : Accessor Ledger_ι_DePool_ι_StakeInfo :=  {  acc := ·8  }   . 
Global Instance Acc_Ledger_ι_TestElector_ι_Validator : Accessor Ledger_ι_TestElector_ι_Validator :=  {  acc := ·9  }   . 
Global Instance Acc_Ledger_ι_StakingProxyContract : Accessor Ledger_ι_StakingProxyContract :=  {  acc := ·10  }   . 
 *)Instance Ledger_default : XDefault Ledger :=  {  
 	 default := LedgerC default default default default (* default default default default default default  default *)
  }   . 
...
Definition T1 := OwnerBase_ι_Owner. 
Definition T2 := ElectorBase_ι_Request. 
Definition T3 := ElectionParams_ι_ValidatorDescr73. 
Definition T4 := StakeholderBase_ι_Stakeholder. 
...
Lemma injproj_T1 : forall (s : Ledger), 
      injEmbed_T1 (projEmbed_T1 s) s = s.
Proof.
...
Lemma injproj_T2 : forall (s : Ledger), 
      injEmbed_T2 (projEmbed_T2 s) s = s.
Proof.
 intros. destruct s. compute. auto.
Qed.
...
Lemma injproj_T3 : forall (s : Ledger), 
      injEmbed_T3 (projEmbed_T3 s) s = s.
Proof.
 intros. destruct s. compute. auto.
Qed.
...
Lemma injproj_T4 : forall (s : Ledger), 
      injEmbed_T4 (projEmbed_T4 s) s = s.
Proof.
 intros. destruct s. compute. auto.
Qed.
...
Check InjectCommutableStates_T1xT2_T3.
...
Check embeddedProduct_T1xT2_T3.
...
Lemma fullState_T1xT2xT3_T4: forall s s0, 
      injEmbed ( T:=(T1 * T2 * T3) ) (projEmbed s) (injEmbed (T:=T4) (projEmbed s) s0) = s.
Proof.
...
Notation "'↑0' m" := (liftEmbeddedState (T:=T1*T2*T3) m) (at level 10, left associativity): solidity_scope.
