...
| String "+"%char t => String " "%char (String "+"%char (String " "%char (setSpace t)))
| String "."%char t => String " "%char (String "."%char (String " "%char (setSpace t)))
| String "!"%char t => (String "!"%char (String " "%char (setSpace t)))
...
| h1 :: "=" :: h2 :: "^^" :: h3 :: "[":: n :: "]" :: t => match who h1 with
                          | NUMBER => h1 :: "=" :: h2 :: "^^" :: h3 :: "[":: n :: "]" :: set_assingment t
...
| h1 :: "=" :: h2 :: "^^" :: h3 :: t => match who h1 with
                          | NUMBER => h1 :: "=" :: h2 :: "^^" :: h3 :: set_assingment t
...
| h1 :: "=" :: h2 :: "[":: n :: "]" :: t => match who h1 with
                          | NUMBER => h1 :: "=" :: h2 :: "[":: n :: "]" :: set_assingment t
...
| h1 :: "=" :: h2 :: t => match who h1, who h2 with
                          | NUMBER, _ => h1 :: "=" :: h2 :: set_assingment t
...
["Definition"] ++ [nf] ++ (get_argum arg) ++ 
  ...
  ( set_plus_assingment ( set_minus_assingment (
 ( set_assingment ( get_to_sol body ) ) ) ) ++   ["."] ) 

                       (get_contract t) ) :: (make_contracts t) 
