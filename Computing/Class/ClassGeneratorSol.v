...
(* Pulling list elements specified one *)
...
Record" :: t => let name := headS "" t in
                ...
                then newline :: "Record" :: adding_parameters tl t
                     ...
                     let new := pulling_list_elements ")" n in
                     let new_param := list_of_uniq_types param new in
                     newline :: "Record" :: name :: "{" :: new_param ++ "}" :: crotch ++ body ++ "." :: 
      "Arguments" :: argu_name ++ "[" :: new_param ++ ["]"] ++ tail' tl t
...
Extraction "./ClassGeneratorSol" main.
