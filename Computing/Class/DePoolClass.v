...
Inductive RoundsBase_ι_RoundStepP := 
 ...
 Record CheckAndAcceptBaseP { I8 }  := CheckAndAcceptBaseC  { 
 	CheckAndAcceptBase_ι_STATUS_SUCCESS : I8  ;   (* constant := 0  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_STAKE_TOO_SMALL : I8  ;   (* constant := 1  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_DEPOOL_CLOSED : I8  ;   (* constant := 3  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_ROUND_STAKE_LIMIT : I8  ;   (* constant := 4  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_MSG_VAL_TOO_SMALL : I8  ;   (* constant := 5  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_NO_PARTICIPANT : I8  ;   (* constant := 6  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_NO_TRANSFER_WHILE_PENDING_ROUND : I8  ;   (* constant := 8  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_VESTING : I8  ;   (* constant := 9  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_GREATER_TOTAL_PERIOD : I8  ;   (* constant := 10  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_MORE_18YEARS : I8  ;   (* constant := 11  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_IS_ZERO : I8  ;   (* constant := 12  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_IS_NOT_DIVED_BY_WITHDRAWAL_PERIOD : I8  ;   (* constant := 13  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_PERIOD_PAYMENT_IS_ZERO : I8  ;   (* constant := 14  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_REMAINING_STAKE_LESS_THAN_MINIMAL : I8  ;   (* constant := 16  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_LOCK : I8  ;   (* constant := 17  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_TRANSFER_AMOUNT_IS_TOO_BIG : I8  ;   (* constant := 18  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_TRANSFER_SELF : I8  ;   (* constant := 19  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_WRONG_PARAMS : I8  ;   (* constant := 20  ;  *) 
 	CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_NO_PUBKEY : I8  ;   (* constant := 21  ;  *) 
 
 }   . 
 
 Arguments CheckAndAcceptBaseC  [  I8  ]   . 
 ...
 Record ProxyBaseP { HM : Type->Type->Type }{ I A }  := ProxyBaseC  { 
 	ProxyBase_ι_m_proxies : HM I A  
 
 }   . 
 
 Arguments ProxyBaseC  [  HM I A ]   . 
...
Record DePoolLib_ι_ParticipantP  {  I8 I64 B  }  := DePoolLib_ι_ParticipantC  { 
 ...
 Arguments ParticipantBaseC  [ HM A I8 I64 B ] 
   ...
   . 
 Record DePoolHelperP { I A } { HM : Type->Type->Type }  := DePoolHelperC  { 
 ...
 Record DePoolProxyContractP { I64 I A }  := DePoolProxyContractC  { 
 	DePoolProxyContract_ι_MIN_BALANCE : I64  ;   (* constant := 5 ton  ;  *) 
 	DePoolProxyContract_ι_ERROR_IS_NOT_OWNER : I  ;   (* constant := 101  ;  *) 
 ...
 Record LocalStateP { I I64 A C B I256 I32 I8 I128 I16 } { HM : Type->Type->Type }  := LocalStateC  { 
 	...
 	LocalState_ι__settimer_Л_opex : I  ; 
 	...
 	LocalState_ι_activeAndNotStakeSum_Л_stakes : (@ RoundsBase_ι_StakeValueP I64 )  ; 
 	LocalState_ι_activeStakeSum_Л_stakes : (@ RoundsBase_ι_StakeValueP I64 )  ; 
 	...
 	LocalState_ι_cutWithdrawalValueAndActivateStake_Л_p : (@ RoundsBase_ι_InvestParamsP B I64 I32 A )  ; 
 	LocalState_ι_cutWithdrawalValueAndActivateStake_Л_periodQty : I64  ; 
 ...
 Arguments LocalStateC  [ I I64 A C B I256 I32 I8 I128 I16 HM ] 
   ...
   . 
 Record LedgerP { I32 I8 A } { HM : Type->Type->Type } { I64 B I I16 I256 S I128 C } { L : Type->Type }  := LedgerC  { 
 	Ledger_ι_DebugDePool : (@ DebugDePoolP I32 )  ; 
 	Ledger_ι_CheckAndAcceptBase : (@ CheckAndAcceptBaseP I8 )  ; 
 	Ledger_ι_ValidatorBase : (@ ValidatorBaseP A )  ; 
 	Ledger_ι_ProxyBase : (@ ProxyBaseP HM I A )  ; 
 	Ledger_ι_ConfigParamsBase : True  ; 
 	Ledger_ι_ParticipantBase : (@ ParticipantBaseP HM A I8 I64 B )  ; 
 	Ledger_ι_DePoolHelper : (@ DePoolHelperP I A HM )  ; 
 	Ledger_ι_Errors : (@ ErrorsP I )  ; 
 	Ledger_ι_InternalErrors : (@ InternalErrorsP I )  ; 
 	Ledger_ι_DePoolLib : (@ DePoolLibP I64 I32 )  ; 
 	Ledger_ι_DePoolProxyContract : (@ DePoolProxyContractP I64 I A )  ; 
 ...
 Arguments LedgerC [ I32 I8 A HM I64 B I I16 I256 S I128 C L ] . 
...
(* Definition DebugDePoolT := StateT DebugDePool . *) 
 ...
 Definition CheckAndAcceptBase := @CheckAndAcceptBaseP XInteger8 . 
Global Instance Struct_CheckAndAcceptBase : Struct CheckAndAcceptBase :=  { 
 	fields :=  [ 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_SUCCESS , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_STAKE_TOO_SMALL , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_DEPOOL_CLOSED , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_ROUND_STAKE_LIMIT , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_MSG_VAL_TOO_SMALL , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_NO_PARTICIPANT , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_NO_TRANSFER_WHILE_PENDING_ROUND , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_VESTING , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_GREATER_TOTAL_PERIOD , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_MORE_18YEARS , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_IS_ZERO , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_IS_NOT_DIVED_BY_WITHDRAWAL_PERIOD , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_PERIOD_PAYMENT_IS_ZERO , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_REMAINING_STAKE_LESS_THAN_MINIMAL , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_LOCK , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_TRANSFER_AMOUNT_IS_TOO_BIG , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_TRANSFER_SELF , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_WRONG_PARAMS , 
 		@existT _ _ _ CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_NO_PUBKEY 
 
 	 ]   ;  
 	 ctor := @CheckAndAcceptBaseC XInteger8 
 }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_SUCCESS : Accessor CheckAndAcceptBase_ι_STATUS_SUCCESS :=  {  acc := ·0  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_STAKE_TOO_SMALL : Accessor CheckAndAcceptBase_ι_STATUS_STAKE_TOO_SMALL :=  {  acc := ·1  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_DEPOOL_CLOSED : Accessor CheckAndAcceptBase_ι_STATUS_DEPOOL_CLOSED :=  {  acc := ·2  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_ROUND_STAKE_LIMIT : Accessor CheckAndAcceptBase_ι_STATUS_ROUND_STAKE_LIMIT :=  {  acc := ·3  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_MSG_VAL_TOO_SMALL : Accessor CheckAndAcceptBase_ι_STATUS_MSG_VAL_TOO_SMALL :=  {  acc := ·4  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_NO_PARTICIPANT : Accessor CheckAndAcceptBase_ι_STATUS_NO_PARTICIPANT :=  {  acc := ·5  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_NO_TRANSFER_WHILE_PENDING_ROUND : Accessor CheckAndAcceptBase_ι_STATUS_NO_TRANSFER_WHILE_PENDING_ROUND :=  {  acc := ·6  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_VESTING : Accessor CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_VESTING :=  {  acc := ·7  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_GREATER_TOTAL_PERIOD : Accessor CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_GREATER_TOTAL_PERIOD :=  {  acc := ·8  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_MORE_18YEARS : Accessor CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_MORE_18YEARS :=  {  acc := ·9  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_IS_ZERO : Accessor CheckAndAcceptBase_ι_STATUS_WITHDRAWAL_PERIOD_IS_ZERO :=  {  acc := ·10  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_IS_NOT_DIVED_BY_WITHDRAWAL_PERIOD : Accessor CheckAndAcceptBase_ι_STATUS_TOTAL_PERIOD_IS_NOT_DIVED_BY_WITHDRAWAL_PERIOD :=  {  acc := ·11  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_PERIOD_PAYMENT_IS_ZERO : Accessor CheckAndAcceptBase_ι_STATUS_PERIOD_PAYMENT_IS_ZERO :=  {  acc := ·12  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_REMAINING_STAKE_LESS_THAN_MINIMAL : Accessor CheckAndAcceptBase_ι_STATUS_REMAINING_STAKE_LESS_THAN_MINIMAL :=  {  acc := ·13  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_LOCK : Accessor CheckAndAcceptBase_ι_STATUS_PARTICIPANT_HAVE_ALREADY_LOCK :=  {  acc := ·14  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_TRANSFER_AMOUNT_IS_TOO_BIG : Accessor CheckAndAcceptBase_ι_STATUS_TRANSFER_AMOUNT_IS_TOO_BIG :=  {  acc := ·15  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_TRANSFER_SELF : Accessor CheckAndAcceptBase_ι_STATUS_TRANSFER_SELF :=  {  acc := ·16  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_WRONG_PARAMS : Accessor CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_WRONG_PARAMS :=  {  acc := ·17  }   . 
Global Instance Acc_CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_NO_PUBKEY : Accessor CheckAndAcceptBase_ι_STATUS_CONSTRUCTOR_NO_PUBKEY :=  {  acc := ·18  }   . 
Instance CheckAndAcceptBase_default : XDefault CheckAndAcceptBase :=  {  
 	 default := CheckAndAcceptBaseC default default default default default default default default default default default default default default default default default default default  
  }   . 
(* Definition CheckAndAcceptBaseT := StateT CheckAndAcceptBase . *) 
...
(* Definition ValidatorBaseT := StateT ValidatorBase . *) 
 ...
 Definition ProxyBase := @ProxyBaseP XHMap XInteger XAddress .  
Global Instance Struct_ProxyBase : Struct ProxyBase :=  { 
 	fields :=  [ 
 		@existT _ _ _ ProxyBase_ι_m_proxies 
 
 	 ]   ;  
 	 ctor := @ProxyBaseC XHMap XInteger XAddress
 }   . 
Global Instance Acc_ProxyBase_ι_m_proxies : Accessor ProxyBase_ι_m_proxies :=  {  acc := ·0  }   . 
...
Global Instance Struct_DePoolHelper : Struct DePoolHelper :=  { 
 	fields :=  [ 
 	 ...
 	 ctor := @DePoolHelperC XInteger XAddress XHMap 
 }   . 
...
(* Definition DePoolLibT := StateT DePoolLib . *) 
 ...
 Definition DePoolProxyContract := @DePoolProxyContractP XInteger64 XInteger XAddress . 
Global Instance Struct_DePoolProxyContract : Struct DePoolProxyContract :=  { 
 	fields :=  [ 
 		@existT _ _ _ DePoolProxyContract_ι_MIN_BALANCE , 
 		@existT _ _ _ DePoolProxyContract_ι_ERROR_IS_NOT_OWNER , 
 	 ...
 	 ctor := @DePoolProxyContractC XInteger64 XInteger XAddress 
 }   . 
Global Instance Acc_DePoolProxyContract_ι_MIN_BALANCE : Accessor DePoolProxyContract_ι_MIN_BALANCE :=  {  acc := ·0  }   . 
Global Instance Acc_DePoolProxyContract_ι_ERROR_IS_NOT_OWNER : Accessor DePoolProxyContract_ι_ERROR_IS_NOT_OWNER :=  {  acc := ·1  }   . 
Global Instance Acc_DePoolProxyContract_ι_ERROR_IS_NOT_DEPOOL : Accessor DePoolProxyContract_ι_ERROR_IS_NOT_DEPOOL :=  {  acc := ·2  }   . 
Global Instance Acc_DePoolProxyContract_ι_ERROR_BAD_BALANCE : Accessor DePoolProxyContract_ι_ERROR_BAD_BALANCE :=  {  acc := ·3  }   . 
Global Instance Acc_DePoolProxyContract_ι_m_dePool : Accessor DePoolProxyContract_ι_m_dePool :=  {  acc := ·4  }   . 
Instance DePoolProxyContract_default : XDefault DePoolProxyContract :=  {  
 	 default := DePoolProxyContractC default default default default default  
  }   . 
...
Global Instance Acc_DePoolContract_ι_m_poolClosed : Accessor DePoolContract_ι_m_poolClosed :=  {  acc := ·14  }   . 
Global Instance Acc_DePoolContract_ι_m_minStake : Accessor DePoolContract_ι_m_minStake :=  {  acc := ·15  }   . 
Global Instance Acc_DePoolContract_ι_m_minRoundStake : Accessor DePoolContract_ι_m_minRoundStake :=  {  acc := ·16  }   . 
Global Instance Acc_DePoolContract_ι_m_lastRoundInterest : Accessor DePoolContract_ι_m_lastRoundInterest :=  {  acc := ·17  }   . 
Instance DePoolContract_default : XDefault DePoolContract :=  {  
 	 default := DePoolContractC default default default default default default default default default default default default default default default default default default  
  }   . 
...
Global Instance Struct_LocalState : Struct LocalState :=  { 
 	fields :=  [ 
 		...
 		@existT _ _ _ LocalState_ι__settimer_Л_opex , 
 		...
 		@existT _ _ _ LocalState_ι_activeAndNotStakeSum_Л_stakes , 
 		@existT _ _ _ LocalState_ι_activeStakeSum_Л_stakes , 
 		...
 		@existT _ _ _ LocalState_ι_cutWithdrawalValueAndActivateStake_Л_p , 
 		@existT _ _ _ LocalState_ι_cutWithdrawalValueAndActivateStake_Л_periodQty , 
...
Global Instance Acc_LocalState_ι__setOrDeleteParticipant_Л_addr : Accessor LocalState_ι__setOrDeleteParticipant_Л_addr :=  {  acc := ·15  }   . 
Global Instance Acc_LocalState_ι_setTimer_Л_timer : Accessor LocalState_ι_setTimer_Л_timer :=  {  acc := ·16  }   . 
Global Instance Acc_LocalState_ι_updateDePoolPoolAddress_Л_addr : Accessor LocalState_ι_updateDePoolPoolAddress_Л_addr :=  {  acc := ·17  }   . 
Global Instance Acc_LocalState_ι_initTimer_Л_timer : Accessor LocalState_ι_initTimer_Л_timer :=  {  acc := ·18  }   . 
Global Instance Acc_LocalState_ι_initTimer_Л_period : Accessor LocalState_ι_initTimer_Л_period :=  {  acc := ·19  }   . 
Global Instance Acc_LocalState_ι__settimer_Л_timer : Accessor LocalState_ι__settimer_Л_timer :=  {  acc := ·20  }   . 
Global Instance Acc_LocalState_ι__settimer_Л_period : Accessor LocalState_ι__settimer_Л_period :=  {  acc := ·21  }   . 
Global Instance Acc_LocalState_ι__settimer_Л_opex : Accessor LocalState_ι__settimer_Л_opex :=  {  acc := ·22  }   . 
...
Global Instance Acc_LocalState_ι_activeAndNotStakeSum_Л_stakes : Accessor LocalState_ι_activeAndNotStakeSum_Л_stakes :=  {  acc := ·53  }   . 
Global Instance Acc_LocalState_ι_activeStakeSum_Л_stakes : Accessor LocalState_ι_activeStakeSum_Л_stakes :=  {  acc := ·54  }   . 
Global Instance Acc_LocalState_ι_toTruncatedRound_Л_round : Accessor LocalState_ι_toTruncatedRound_Л_round :=  {  acc := ·55  }   . 
Global Instance Acc_LocalState_ι__calcLastRoundInterest_Л_totalStake : Accessor LocalState_ι__calcLastRoundInterest_Л_totalStake :=  {  acc := ·56  }   . 
Global Instance Acc_LocalState_ι__calcLastRoundInterest_Л_rewards : Accessor LocalState_ι__calcLastRoundInterest_Л_rewards :=  {  acc := ·57  }   . 
Global Instance Acc_LocalState_ι__sendError_Л_errcode : Accessor LocalState_ι__sendError_Л_errcode :=  {  acc := ·58  }   . 
Global Instance Acc_LocalState_ι__sendError_Л_comment : Accessor LocalState_ι__sendError_Л_comment :=  {  acc := ·59  }   . 
Global Instance Acc_LocalState_ι__sendAccept_Л_fee : Accessor LocalState_ι__sendAccept_Л_fee :=  {  acc := ·60  }   . 
Global Instance Acc_LocalState_ι_startRoundCompleting_Л_round : Accessor LocalState_ι_startRoundCompleting_Л_round :=  {  acc := ·61  }   . 
Global Instance Acc_LocalState_ι_startRoundCompleting_Л_reason : Accessor LocalState_ι_startRoundCompleting_Л_reason :=  {  acc := ·62  }   . 
Global Instance Acc_LocalState_ι_cutWithdrawalValueAndActivateStake_Л_p : Accessor LocalState_ι_cutWithdrawalValueAndActivateStake_Л_p :=  {  acc := ·63  }   . 
Global Instance Acc_LocalState_ι_cutWithdrawalValueAndActivateStake_Л_periodQty : Accessor LocalState_ι_cutWithdrawalValueAndActivateStake_Л_periodQty :=  {  acc := ·64  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvestForParticipant_Л_completedRound : Accessor LocalState_ι__returnOrReinvestForParticipant_Л_completedRound :=  {  acc := ·65  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvestForParticipant_Л_round0 : Accessor LocalState_ι__returnOrReinvestForParticipant_Л_round0 :=  {  acc := ·66  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvestForParticipant_Л_addr : Accessor LocalState_ι__returnOrReinvestForParticipant_Л_addr :=  {  acc := ·67  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvestForParticipant_Л_stakes : Accessor LocalState_ι__returnOrReinvestForParticipant_Л_stakes :=  {  acc := ·68  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvestForParticipant_Л_validatorIsPunished : Accessor LocalState_ι__returnOrReinvestForParticipant_Л_validatorIsPunished :=  {  acc := ·69  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvest_Л_round : Accessor LocalState_ι__returnOrReinvest_Л_round :=  {  acc := ·70  }   . 
Global Instance Acc_LocalState_ι__returnOrReinvest_Л_chunkSize : Accessor LocalState_ι__returnOrReinvest_Л_chunkSize :=  {  acc := ·71  }   . 
Global Instance Acc_LocalState_ι_calculateStakeWithAssert_Л_doSplit : Accessor LocalState_ι_calculateStakeWithAssert_Л_doSplit :=  {  acc := ·72  }   . 
Global Instance Acc_LocalState_ι_calculateStakeWithAssert_Л_wholeFee : Accessor LocalState_ι_calculateStakeWithAssert_Л_wholeFee :=  {  acc := ·73  }   . 
Global Instance Acc_LocalState_ι_calculateStakeWithAssert_Л_div : Accessor LocalState_ι_calculateStakeWithAssert_Л_div :=  {  acc := ·74  }   . 
Global Instance Acc_LocalState_ι_addOrdinaryStake_Л_reinvest : Accessor LocalState_ι_addOrdinaryStake_Л_reinvest :=  {  acc := ·75  }   . 
Global Instance Acc_LocalState_ι_removeOrdinaryStake_Л_withdrawValue : Accessor LocalState_ι_removeOrdinaryStake_Л_withdrawValue :=  {  acc := ·76  }   . 
Global Instance Acc_LocalState_ι_addVestingStake_Л_beneficiary : Accessor LocalState_ι_addVestingStake_Л_beneficiary :=  {  acc := ·77  }   . 
Global Instance Acc_LocalState_ι_addVestingStake_Л_withdrawalPeriod : Accessor LocalState_ι_addVestingStake_Л_withdrawalPeriod :=  {  acc := ·78  }   . 
Global Instance Acc_LocalState_ι_addVestingStake_Л_totalPeriod : Accessor LocalState_ι_addVestingStake_Л_totalPeriod :=  {  acc := ·79  }   . 
Global Instance Acc_LocalState_ι_addLockStake_Л_beneficiary : Accessor LocalState_ι_addLockStake_Л_beneficiary :=  {  acc := ·80  }   . 
Global Instance Acc_LocalState_ι_addLockStake_Л_withdrawalPeriod : Accessor LocalState_ι_addLockStake_Л_withdrawalPeriod :=  {  acc := ·81  }   . 
Global Instance Acc_LocalState_ι_addLockStake_Л_totalPeriod : Accessor LocalState_ι_addLockStake_Л_totalPeriod :=  {  acc := ·82  }   . 
Global Instance Acc_LocalState_ι_addVestingOrLock_Л_beneficiary : Accessor LocalState_ι_addVestingOrLock_Л_beneficiary :=  {  acc := ·83  }   . 
Global Instance Acc_LocalState_ι_addVestingOrLock_Л_withdrawalPeriod : Accessor LocalState_ι_addVestingOrLock_Л_withdrawalPeriod :=  {  acc := ·84  }   . 
Global Instance Acc_LocalState_ι_addVestingOrLock_Л_totalPeriod : Accessor LocalState_ι_addVestingOrLock_Л_totalPeriod :=  {  acc := ·85  }   . 
Global Instance Acc_LocalState_ι_addVestingOrLock_Л_isVesting : Accessor LocalState_ι_addVestingOrLock_Л_isVesting :=  {  acc := ·86  }   . 
Global Instance Acc_LocalState_ι_withdrawPartAfterCompleting_Л_withdrawValue : Accessor LocalState_ι_withdrawPartAfterCompleting_Л_withdrawValue :=  {  acc := ·87  }   . 
Global Instance Acc_LocalState_ι_withdrawAllAfterCompleting_Л_doWithdrawAll : Accessor LocalState_ι_withdrawAllAfterCompleting_Л_doWithdrawAll :=  {  acc := ·88  }   . 
Global Instance Acc_LocalState_ι_transferStake_Л_dest : Accessor LocalState_ι_transferStake_Л_dest :=  {  acc := ·89  }   . 
Global Instance Acc_LocalState_ι_transferStake_Л_amount : Accessor LocalState_ι_transferStake_Л_amount :=  {  acc := ·90  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_queryId : Accessor LocalState_ι_participateInElections_Л_queryId :=  {  acc := ·91  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_validatorKey : Accessor LocalState_ι_participateInElections_Л_validatorKey :=  {  acc := ·92  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_stakeAt : Accessor LocalState_ι_participateInElections_Л_stakeAt :=  {  acc := ·93  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_maxFactor : Accessor LocalState_ι_participateInElections_Л_maxFactor :=  {  acc := ·94  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_adnlAddr : Accessor LocalState_ι_participateInElections_Л_adnlAddr :=  {  acc := ·95  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_signature : Accessor LocalState_ι_participateInElections_Л_signature :=  {  acc := ·96  }   . 
Global Instance Acc_LocalState_ι_participateInElections_Л_WaitingValidatorRequest : Accessor LocalState_ι_participateInElections_Л_WaitingValidatorRequest :=  {  acc := ·97  }   . 
Global Instance Acc_LocalState_ι_generateRound_Л_MAX_TIME : Accessor LocalState_ι_generateRound_Л_MAX_TIME :=  {  acc := ·98  }   . 
Global Instance Acc_LocalState_ι_generateRound_Л_Pooling : Accessor LocalState_ι_generateRound_Л_Pooling :=  {  acc := ·99  }   . 
Global Instance Acc_LocalState_ι_generateRound_Л_Undefined : Accessor LocalState_ι_generateRound_Л_Undefined :=  {  acc := ·100  }   . 
Global Instance Acc_LocalState_ι_updateRound2_Л_round2 : Accessor LocalState_ι_updateRound2_Л_round2 :=  {  acc := ·101  }   . 
Global Instance Acc_LocalState_ι_updateRound2_Л_prevValidatorHash : Accessor LocalState_ι_updateRound2_Л_prevValidatorHash :=  {  acc := ·102  }   . 
Global Instance Acc_LocalState_ι_updateRound2_Л_curValidatorHash : Accessor LocalState_ι_updateRound2_Л_curValidatorHash :=  {  acc := ·103  }   . 
Global Instance Acc_LocalState_ι_updateRound2_Л_validationStart : Accessor LocalState_ι_updateRound2_Л_validationStart :=  {  acc := ·104  }   . 
Global Instance Acc_LocalState_ι_updateRound2_Л_stakeHeldFor : Accessor LocalState_ι_updateRound2_Л_stakeHeldFor :=  {  acc := ·105  }   . 
Global Instance Acc_LocalState_ι_updateRounds_Л_validationStart : Accessor LocalState_ι_updateRounds_Л_validationStart :=  {  acc := ·106  }   . 
Global Instance Acc_LocalState_ι_completeRoundWithChunk_Л_roundId : Accessor LocalState_ι_completeRoundWithChunk_Л_roundId :=  {  acc := ·107  }   . 
Global Instance Acc_LocalState_ι_completeRoundWithChunk_Л_chunkSize : Accessor LocalState_ι_completeRoundWithChunk_Л_chunkSize :=  {  acc := ·108  }   . 
Global Instance Acc_LocalState_ι_completeRoundWithChunk_Л_Completing : Accessor LocalState_ι_completeRoundWithChunk_Л_Completing :=  {  acc := ·109  }   . 
Global Instance Acc_LocalState_ι_completeRound_Л_roundId : Accessor LocalState_ι_completeRound_Л_roundId :=  {  acc := ·110  }   . 
Global Instance Acc_LocalState_ι_completeRound_Л_participantQty : Accessor LocalState_ι_completeRound_Л_participantQty :=  {  acc := ·111  }   . 
Global Instance Acc_LocalState_ι_completeRound_Л_Completing : Accessor LocalState_ι_completeRound_Л_Completing :=  {  acc := ·112  }   . 
Global Instance Acc_LocalState_ι_onStakeAccept_Л_elector : Accessor LocalState_ι_onStakeAccept_Л_elector :=  {  acc := ·113  }   . 
Global Instance Acc_LocalState_ι_onStakeAccept_Л_WaitingIfStakeAccepted : Accessor LocalState_ι_onStakeAccept_Л_WaitingIfStakeAccepted :=  {  acc := ·114  }   . 
Global Instance Acc_LocalState_ι_onStakeReject_Л_elector : Accessor LocalState_ι_onStakeReject_Л_elector :=  {  acc := ·115  }   . 
Global Instance Acc_LocalState_ι_onStakeReject_Л_WaitingIfStakeAccepted : Accessor LocalState_ι_onStakeReject_Л_WaitingIfStakeAccepted :=  {  acc := ·116  }   . 
Global Instance Acc_LocalState_ι_acceptRewardAndStartRoundCompleting_Л_round : Accessor LocalState_ι_acceptRewardAndStartRoundCompleting_Л_round :=  {  acc := ·117  }   . 
Global Instance Acc_LocalState_ι_acceptRewardAndStartRoundCompleting_Л_value : Accessor LocalState_ι_acceptRewardAndStartRoundCompleting_Л_value :=  {  acc := ·118  }   . 
Global Instance Acc_LocalState_ι_acceptRewardAndStartRoundCompleting_Л_effectiveStake : Accessor LocalState_ι_acceptRewardAndStartRoundCompleting_Л_effectiveStake :=  {  acc := ·119  }   . 
Global Instance Acc_LocalState_ι_onSuccessToRecoverStake_Л_elector : Accessor LocalState_ι_onSuccessToRecoverStake_Л_elector :=  {  acc := ·120  }   . 
Global Instance Acc_LocalState_ι_onFailToRecoverStake_Л_queryId : Accessor LocalState_ι_onFailToRecoverStake_Л_queryId :=  {  acc := ·121  }   . 
Global Instance Acc_LocalState_ι_onFailToRecoverStake_Л_elector : Accessor LocalState_ι_onFailToRecoverStake_Л_elector :=  {  acc := ·122  }   . 
Global Instance Acc_LocalState_ι_getParticipantInfo_Л_addr : Accessor LocalState_ι_getParticipantInfo_Л_addr :=  {  acc := ·123  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_roundId : Accessor LocalState_ι_onRoundComplete_Л_roundId :=  {  acc := ·124  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_reward : Accessor LocalState_ι_onRoundComplete_Л_reward :=  {  acc := ·125  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_ordinaryStake : Accessor LocalState_ι_onRoundComplete_Л_ordinaryStake :=  {  acc := ·126  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_vestingStake : Accessor LocalState_ι_onRoundComplete_Л_vestingStake :=  {  acc := ·127  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_lockStake : Accessor LocalState_ι_onRoundComplete_Л_lockStake :=  {  acc := ·128  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_reinvest : Accessor LocalState_ι_onRoundComplete_Л_reinvest :=  {  acc := ·129  }   . 
Global Instance Acc_LocalState_ι_onRoundComplete_Л_reason : Accessor LocalState_ι_onRoundComplete_Л_reason :=  {  acc := ·130  }   . 
Global Instance Acc_LocalState_ι_receiveAnswer_Л_errcode : Accessor LocalState_ι_receiveAnswer_Л_errcode :=  {  acc := ·131  }   . 
Global Instance Acc_LocalState_ι_receiveAnswer_Л_comment : Accessor LocalState_ι_receiveAnswer_Л_comment :=  {  acc := ·132  }   . 
Global Instance Acc_LocalState_ι_onTransfer_Л_source : Accessor LocalState_ι_onTransfer_Л_source :=  {  acc := ·133  }   . 
Global Instance Acc_LocalState_ι_onTransfer_Л_amount : Accessor LocalState_ι_onTransfer_Л_amount :=  {  acc := ·134  }   . 
Global Instance Acc_LocalState_ι_sendTransaction_Л_dest : Accessor LocalState_ι_sendTransaction_Л_dest :=  {  acc := ·135  }   . 
Global Instance Acc_LocalState_ι_sendTransaction_Л_value : Accessor LocalState_ι_sendTransaction_Л_value :=  {  acc := ·136  }   . 
Global Instance Acc_LocalState_ι_sendTransaction_Л_bounce : Accessor LocalState_ι_sendTransaction_Л_bounce :=  {  acc := ·137  }   . 
Global Instance Acc_LocalState_ι_sendTransaction_Л_flags : Accessor LocalState_ι_sendTransaction_Л_flags :=  {  acc := ·138  }   . 
Global Instance Acc_LocalState_ι_sendTransaction_Л_payload : Accessor LocalState_ι_sendTransaction_Л_payload :=  {  acc := ·139  }   . 
Global Instance Acc_LocalState_ι_acceptRecoveredStake_Л_queryId : Accessor LocalState_ι_acceptRecoveredStake_Л_queryId :=  {  acc := ·140  }   . 
Global Instance Acc_LocalState_ι_sendError_Л_queryId : Accessor LocalState_ι_sendError_Л_queryId :=  {  acc := ·141  }   . 
Global Instance Acc_LocalState_ι_sendError_Л_op : Accessor LocalState_ι_sendError_Л_op :=  {  acc := ·142  }   . 
Instance LocalState_default : XDefault LocalState :=  {  
 	 default := LocalStateC default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default default  
  }   . 
(* Definition LocalStateT := StateT LocalState . *) 
 
  
 Definition Ledger := @LedgerP XInteger32 XInteger8 XAddress XHMap XInteger64 XBool XInteger XInteger16 XInteger256 XString XInteger128 TvmCell XList . 
Global Instance Struct_Ledger : Struct Ledger :=  { 
 	fields :=  [ 
 		@existT _ _ _ Ledger_ι_DebugDePool , 
 		@existT _ _ _ Ledger_ι_CheckAndAcceptBase , 
 	 ...
 	 ctor := @LedgerC XInteger32 XInteger8 XAddress XHMap XInteger64 XBool XInteger XInteger16 XInteger256 XString XInteger128 TvmCell XList 
 }   . 
Global Instance Acc_Ledger_ι_DebugDePool : Accessor Ledger_ι_DebugDePool :=  {  acc := ·0  }   . 
Global Instance Acc_Ledger_ι_CheckAndAcceptBase : Accessor Ledger_ι_CheckAndAcceptBase :=  {  acc := ·1  }   . 
...
{$ t with f := x $}.
 ...
 Definition T2 := CheckAndAcceptBase . 
 Definition T3 := ValidatorBase . 
 Definition T4 := ProxyBase . 
 ...
 Definition T11 := DePoolContract . 
 Definition T12 := TestElector . 
 Definition T13 := VMState . 
 Definition T14 := LocalState . 
...
Qed. 
 ...
 Definition projEmbed_T13 : Ledger -> T13 := projEmbed_Accessor . 
 Definition injEmbed_T13 : T13 -> Ledger -> Ledger := injEmbed_Accessor . 
...
Qed. 
 ...
 Definition projEmbed_T14 : Ledger -> T14 := projEmbed_Accessor . 
 Definition injEmbed_T14 : T14 -> Ledger -> Ledger := injEmbed_Accessor . 
...
Axiom fullState_T1xT2xT3xT4xT5xT6xT7xT8xT9xT10xT11xT12xT13_T14 : forall s s0, 
      injEmbed ( T:=(  T1 * T2 * T3 * T4 * T5 * T6 * T7 * T8 * T9 * T10 * T11 * T12 * T13  ) ) 
(projEmbed s) (injEmbed (T:= T14 ) (projEmbed s) s0) = s.
(* Lemma fullState_T1xT2xT3xT4xT5xT6xT7xT8xT9xT10xT11xT12xT13_T14 : forall s s0, 
      injEmbed ( T:=(  T1 * T2 * T3 * T4 * T5 * T6 * T7 * T8 * T9 * T10 * T11 * T12 * T13  ) ) 
(projEmbed s) (injEmbed (T:= T14 ) (projEmbed s) s0) = s.
Proof.
...
Instance FullState_T1xT2xT3xT4xT5xT6xT7xT8xT9xT10xT11xT12xT13_T14 : 
         FullState Ledger ( T1 * T2 * T3 * T4 * T5 * T6 * T7 * T8 * T9 * T10 * T11 * T12 * T13  ) T14 := 
{
  injComm := InjectCommutableStates_T1xT2xT3xT4xT5xT6xT7xT8xT9xT10xT11xT12xT13_T14 ;
  fullState := fullState_T1xT2xT3xT4xT5xT6xT7xT8xT9xT10xT11xT12xT13_T14 
}. 
Notation "'↑14' m":= (liftEmbeddedState ( T := T14 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑13' m":= (liftEmbeddedState ( T := T13 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑12' m":= (liftEmbeddedState ( T := T12 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑11' m":= (liftEmbeddedState ( T := T11 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑10' m":= (liftEmbeddedState ( T := T10 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑9' m":= (liftEmbeddedState ( T := T9 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑8' m":= (liftEmbeddedState ( T := T8 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑7' m":= (liftEmbeddedState ( T := T7 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑6' m":= (liftEmbeddedState ( T := T6 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑5' m":= (liftEmbeddedState ( T := T5 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑4' m":= (liftEmbeddedState ( T := T4 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑3' m":= (liftEmbeddedState ( T := T3 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑2' m":= (liftEmbeddedState ( T := T2 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation "'↑1' m":= (liftEmbeddedState ( T := T1 ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
Notation " '↑0' m " := ( liftEmbeddedState ( T :=  T1 * T2 * T3 * T4 * T5 * T6 * T7 * T8 * T9 * T10 * T11 * T12 * T13  ) ( ε m )%sol ) (at level 10, left associativity): solidity_scope. 
 
 Notation " '↑↑1' n '^^' m " := ( do a ← (↑5 n  ) ; return! ( m a )  )%sol(at level 10, left associativity): solidity_scope.
 Notation " '↑↑2' n '^^' m " := ( do a ← (↑14 n  ) ; return! ( m a )  )%sol(at level 10, left associativity): solidity_scope.
 Notation " '↑↑3' n '^^' m " := ( do a ← (↑14 n  ) ; return! ( m a )  )%sol(at level 10, left associativity): solidity_scope.
