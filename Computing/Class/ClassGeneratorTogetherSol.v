...
then ""
else(newline++"Definition"++" "++contract_name++"T"++" := "++"StateT"++" "++contract_name ++" . "++
          newline++"End "++contract_name++"Class "++"."++newline++newline)%string in 
...
let union := union_all_contructs sl in
let sl := sl ++ union in
