...
Fixpoint concat_op_equ(il:list string)(sl:list string) :=
match sl with
| nil => nil
| "+" :: "=" :: t => "+=" :: (concat_op_equ il t)
| "-" :: "=" :: t => "-=" :: (concat_op_equ il t)
| "/" :: "=" :: t => "/=" :: (concat_op_equ il t)
| "*" :: "=" :: t => "*=" :: (concat_op_equ il t)
| "+" :: "+" :: t => "++" :: (concat_op_equ il t)
...
| "|" :: "|" :: t => "||" :: (concat_op_equ il t)
| "!" :: "=" :: t => "!=" :: (concat_op_equ il t)
| "address" :: "(" :: n :: ")" :: t => ("address"++"("++n++")")%string :: (concat_op_equ il t) 
| "msg" :: "." :: "sender" :: "." :: "transfer" :: t => 
              ("msg"++"."++"sender"++"."++"transfer")%string :: (concat_op_equ il t) 
| "msg" :: "." :: "value" :: t => ("msg"++"."++"value")%string :: (concat_op_equ il t) 
| "msg" :: "." :: "sender" :: t => 
              ("msg"++"."++"sender")%string :: (concat_op_equ il t) 

| i :: "." :: h :: t => if ( test_already_exists i il ) 
                        then (i++"_ι_"++h)%string :: concat_op_equ il t
                        else  i :: "." :: h :: concat_op_equ il t

| h :: t => h :: (concat_op_equ il t)
end.
...
| a :: "!=" :: b :: t => 
      "(" :: "boolNegb" :: "(" :: "xIntEqb" :: a :: b :: ")" :: ")" :: compare_to_coq_mode t
