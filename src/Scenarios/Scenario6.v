...
Module Scenario6  (dc : DePoolConstsTypesSig XTypesSig StateMonadSig).
...
Lemma Scenario_OrdinaryStakeLose_byValidatorAndParticipant: forall 
...
(msg_value_onSuccessToRecoverStake + DePoolLib_ι_PROXY_FEE >=? stakeV + stakeP) = true ->
