...
Module Scenario3  (dc : DePoolConstsTypesSig XTypesSig StateMonadSig).
...
Lemma Scenario_OrdinaryVestingStakeWin_byValidator: forall 
...
let rewardV := stakeSumV * rewards / (stake/2 +stakeV)  in
